...
BEGIN_MESSAGE_MAP(CcomboBoxCtrlDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_CBN_SELCHANGE(IDC_COMBO1, &CcomboBoxCtrlDlg::OnCbnSelchangeCombo1)
END_MESSAGE_MAP()


// CcomboBoxCtrlDlg 消息处理程序
...
void CcomboBoxCtrlDlg::OnCbnSelchangeCombo1()
{
	// TODO: 在此添加控件通知处理程序代码
	CString str;
	int idexe = m_cbx.GetCurSel();
	m_cbx.GetLBText(idexe, str);
	MessageBox(str);
